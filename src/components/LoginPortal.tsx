  ...
  return (
    <div className="min-h-screen bg-[#05050A] flex flex-col justify-center items-center py-12 sm:px-6 lg:px-8 font-sans relative overflow-hidden">
          ...
          <form className="space-y-6" onSubmit={handleLogin}>
            ...
            <div className="space-y-1">
              ...
              {!isSwitching ? (
                <div className="bg-black/50 border border-white/10 rounded-2xl p-4 flex items-center gap-4 relative overflow-hidden group">
                  ...
                  <div className="relative z-10 flex items-center gap-4 w-full">
                    ...
                    <button
                      ...
                      className="relative z-20 text-xs text-purple-400 hover:text-purple-300 font-medium px-3 py-1.5 bg-purple-500/10 hover:bg-purple-500/20 rounded-lg transition-colors whitespace-nowrap cursor-pointer"
                    >
                      Switch Account
                    </button>
                  </div>
                ...
                <div className="bg-[#111116] border border-white/20 rounded-2xl p-2 flex flex-col gap-1 relative overflow-hidden shadow-xl animate-in slide-in-from-top-2">
                    ...
                    {users.map((user) => (
                      <button
                        ...
                        className={cn(
                          ...
                          selectedUserId === user.id ? "bg-purple-500/20 text-white" : "hover:bg-white/5 text-gray-300"
                        )}
                      >
                  ...
                  <div className="pt-2 mt-1 border-t border-white/10">
                    <button
                      ...
                      className="w-full text-center text-xs font-medium text-gray-400 hover:text-white py-2 rounded-lg hover:bg-white/5 transition-colors"
                    >
                      Cancel
                    </button>
                  </div>
            ...
            <div className="pt-2 border-t border-white/5">
              ...
              <div className="grid grid-cols-2 gap-3">
                <button
                  type="button"
                  className="flex flex-col items-center justify-center gap-2 py-3 px-2 bg-white/5 hover:bg-white/10 border border-white/10 rounded-2xl transition-colors group"
                >
      ...
      <div className="absolute bottom-6 w-full text-center z-10 pointer-events-none">
        <p className="text-xs font-medium text-gray-600 tracking-wider">
          © 2026 ClickCamp Enterprise
        </p>
      </div>
    </div>
  );
